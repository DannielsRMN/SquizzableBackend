...
urlpatterns = [
    ...
    path('api/temas/<int:moduloID>/', views.TemasXModulo.as_view(), name='temas-personales'),
    path('api/progresos/<int:usuarioID>/', views.ProgresoPersonales.as_view(), name='progresos-personales'),
    path('api/clasificacion/', views.ClasificacionUsuario.as_view(), name='clasificacion-usuario'),
    path('api/clasificacion/<int:especialidadID>/', views.ClasificacionModularUsuario.as_view(), name='clasificacion-usuario'),
